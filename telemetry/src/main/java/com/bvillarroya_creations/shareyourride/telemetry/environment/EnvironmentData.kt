...
data class EnvironmentData(val gravity: FloatArray, val acceleration: FloatArray, val rotationVector: FloatArray, val TimeStamp: Long) : ITelemetryData {
